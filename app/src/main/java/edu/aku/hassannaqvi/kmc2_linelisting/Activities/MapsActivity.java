...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Collection<VerticesContract> vc = db.getVerticesByCluster(MainApp.villageCode);
        ...
        Collection<VerticesUCContract> vcuc = db.getVerticesByUC(String.valueOf(MainApp.ucCode));
