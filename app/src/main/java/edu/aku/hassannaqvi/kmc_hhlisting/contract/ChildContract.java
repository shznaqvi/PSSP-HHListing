...
/*    private String sC2 = ""; // sB
    ...
    public ChildContract Sync(JSONObject jsonObject) throws JSONException {
        this._ID = jsonObject.getString(ChildTable.COLUMN_ID);
        this._UID = jsonObject.getString(ChildTable.COLUMN_UID);
        this._UUID = jsonObject.getString(ChildTable.COLUMN_UUID);
...
/*        this.sC2 = jsonObject.getString(ChildTable.COLUMN_SC2);
    ...
    public ChildContract Hydrate(Cursor cursor) {
        ...
        this._UID = cursor.getString(cursor.getColumnIndex(ChildTable.COLUMN_UID));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(ChildTable.COLUMN_UID, this._UID == null ? JSONObject.NULL : this._UID);
