...
public class AddChildActivity extends Activity {
    ...
    private boolean UpdateDB() {
        ...
        if (updcount != 0) {
            ...
            AppMain.lc.setHhadd(null);
            AppMain.lc.setHh13(null);
            AppMain.lc.setHh12(null);
    ...
    private void SaveDraft() {
        AppMain.lc.setHhadd(icName.getText().toString());
        AppMain.lc.setHh13(icAgeD.getText().toString());
        AppMain.lc.setHh12(icAgeM.getText().toString());
