...
//        });
    ...
    public void dbBackup() {
        ...
        sharedPref = getSharedPreferences("willowslinelisting", MODE_PRIVATE);
        ...
        if (sharedPref.getBoolean("flag", false)) {
            ...
            File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "DMU-WILLOWS");
