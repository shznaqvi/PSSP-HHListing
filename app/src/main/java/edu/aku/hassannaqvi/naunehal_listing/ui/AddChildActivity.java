...
public class AddChildActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtChildListing.setText("Child Listing: " + MainApp.hl03txt + "-" + MainApp.hl07txt + " (" + MainApp.cCount + " of " + MainApp.cTotal + ")");
    ...
    private boolean UpdateDB() {
        ...
        try {
            Log.d(TAG, "onBtnAddFamilyClick: " + MainApp.listing.toJSONObject().toString());
    ...
    private void SaveDraft() {
        MainApp.listing.setHhChildNm(icName.getText().toString());
        MainApp.listing.setHl12d(icAgeD.getText().toString());
        MainApp.listing.setHl12m(icAgeM.getText().toString());
