...
import edu.aku.hassannaqvi.naunehal_listing.core.AppInfo;
...
import edu.aku.hassannaqvi.naunehal_listing.databinding.ActivityLoginBinding;

import static edu.aku.hassannaqvi.naunehal_listing.CONSTANTS.MINIMUM_DISTANCE_CHANGE_FOR_UPDATES;
import static edu.aku.hassannaqvi.naunehal_listing.CONSTANTS.MINIMUM_TIME_BETWEEN_UPDATES;
import static edu.aku.hassannaqvi.naunehal_listing.CONSTANTS.TWO_MINUTES;
...
import static edu.aku.hassannaqvi.naunehal_listing.database.DatabaseHelper.DB_NAME;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (mlocManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                ...
                if ((musername.equals("dmu@aku") && mPassword.equals("aku?dmu")) ||
                        (musername.equals("guest@aku") && mPassword.equals("aku1234"))
                        //|| db.Login(musername, mPassword)
