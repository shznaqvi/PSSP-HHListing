...
public class SyncListings extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        try {
            String url = AppMain.PROJECT_URI + ListingContract.ListingEntry.URI;
...
//            pd.setMessage("Total Listings: " );
                ...
                for (ListingContract fc : Listings) {
...
//                    db.updateSyncedListings(jsonObject.getString("id"));
                    sSynced++;
                }
                else {
            ...
            Toast.makeText(mContext, sSynced + " Listings synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " Listings synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError);
