package edu.aku.hassannaqvi.cbt_hhlisting.core;
...
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ChildrenContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ChildrenContract.ChildTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ClusterContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ClusterContract.ClusterTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.HFacilitiesContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.HFacilitiesContract.HFacilityTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.LHWsContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.LHWsContract.LHWTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ListingContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.ListingContract.ListingEntry;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.PWsContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.PWsContract.PwTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.TehsilsContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.TehsilsContract.TehsilTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.UCsContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.UCsContract.UcTable;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.UsersContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.UsersContract.singleUser;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.VillagesContract;
import edu.aku.hassannaqvi.cbt_hhlisting.contract.VillagesContract.VillageTable;
...
public class FormsDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_LISTING_TABLE = "CREATE TABLE " + ListingEntry.TABLE_NAME + " (" +
                ListingEntry.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                ...
                ListingEntry.COLUMN_NAME_LHWCODE + " TEXT," +
...
// Create a new map of values, where column names are the keys
        ...
        values.put(ListingEntry.COLUMN_NAME_LHWCODE, lc.getLhwcode());
...
//        values.put(ClusterTable.COLUMN_ID, cc.getID());
...
//        values.put(PwTable.COLUMN_ID, pw.getID());
...
// Which row to update, based on the ID
        String selection = ListingEntry.COLUMN_ID + " LIKE ?";
    ...
    public Collection<ListingContract> getAllListings() {
        ...
        Cursor c = null;
        String[] columns = {
                ListingEntry.COLUMN_ID,
                ListingEntry.COLUMN_NAME_UID,
                ListingEntry.COLUMN_NAME_LHWCODE,
        ...
        try {
            ...
            while (c.moveToNext()) {
                ListingContract lst = new ListingContract();
                allLC.add(lst.hydrate(c));
            }
        } finally {
            if (c != null) {
                c.close();
    ...
    private ContentValues getContentValues(ListingContract lc) {
        ContentValues values = new ContentValues();
        values.put(ListingEntry.COLUMN_ID, lc.getID());
        values.put(ListingEntry.COLUMN_NAME_UID, lc.getUID());
        values.put(ListingEntry.COLUMN_NAME_LHWCODE, lc.getLhwcode());
        values.put(ListingEntry.COLUMN_NAME_HHDATETIME, lc.getHhDT());
        values.put(ListingEntry.COLUMN_NAME_HH01, lc.getHh01());
...
// Which row to update, based on the title
        String where = ListingEntry.COLUMN_ID + " = ?";
        String[] whereArgs = {id};
