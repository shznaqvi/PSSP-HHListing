...
public class pssphhlDBHelperController {
    private final String TAG = pssphhlDBHelperController.class.getSimpleName();

    protected void delete(Context context, String tableName, String statement) {
        Log.d(TAG, "delete");
        pssphhlDBHelper dbhelper = new pssphhlDBHelper(context);
